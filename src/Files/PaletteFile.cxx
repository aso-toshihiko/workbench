...
PaletteFile::addDefaultPalettes()
{
    ...
    //----------------------------------------------------------------------
    // cyangold palette
    // Cyan-Black-Gold diverging colormap
    // Negative = cyan, zero = black, positive = gold/yellow
    //
    if (this->getPaletteByName("cyangold") == NULL) {
        Palette asoDiverging;
        asoDiverging.setName("cyangold");

        // 51 entries sampled from 200-row cyangold LUT
        // i=0: cyan (scalar=-1.0), i=25: near-black (scalar=0.0), i=50: gold (scalar=+1.0)
        this->addColor("_cyangold_00",  26, 253, 255);
        this->addColor("_cyangold_01",   5, 245, 255);
        this->addColor("_cyangold_02",   0, 234, 255);
        this->addColor("_cyangold_03",   0, 223, 255);
        this->addColor("_cyangold_04",   0, 211, 255);
        this->addColor("_cyangold_05",   0, 199, 255);
        this->addColor("_cyangold_06",   0, 186, 255);
        this->addColor("_cyangold_07",   0, 172, 255);
        this->addColor("_cyangold_08",   0, 157, 255);
        this->addColor("_cyangold_09",   0, 142, 255);
        this->addColor("_cyangold_10",   0, 126, 255);
        this->addColor("_cyangold_11",   0, 109, 255);
        this->addColor("_cyangold_12",   0,  91, 255);
        this->addColor("_cyangold_13",   0,  79, 255);
        this->addColor("_cyangold_14",   0,  74, 255);
        this->addColor("_cyangold_15",   0,  68, 255);
        this->addColor("_cyangold_16",   0,  62, 255);
        this->addColor("_cyangold_17",   0,  56, 230);
        this->addColor("_cyangold_18",   0,  50, 203);
        this->addColor("_cyangold_19",   0,  44, 178);
        this->addColor("_cyangold_20",   0,  37, 152);
        this->addColor("_cyangold_21",   0,  30, 124);
        this->addColor("_cyangold_22",   0,  22,  94);
        this->addColor("_cyangold_23",   0,  15,  63);
        this->addColor("_cyangold_24",   0,   7,  31);
        this->addColor("_cyangold_25",   1,   0,   5);
        this->addColor("_cyangold_26",  10,   7,   0);
        this->addColor("_cyangold_27",  25,  17,   0);
        this->addColor("_cyangold_28",  41,  27,   0);
        this->addColor("_cyangold_29",  56,  37,   0);
        this->addColor("_cyangold_30",  72,  48,   0);
        this->addColor("_cyangold_31",  87,  58,   0);
        this->addColor("_cyangold_32", 102,  68,   0);
        this->addColor("_cyangold_33", 117,  78,   0);
        this->addColor("_cyangold_34", 133,  88,   0);
        this->addColor("_cyangold_35", 148,  98,   0);
        this->addColor("_cyangold_36", 164, 109,   0);
        this->addColor("_cyangold_37", 179, 119,   0);
        this->addColor("_cyangold_38", 192, 129,   0);
        this->addColor("_cyangold_39", 197, 139,   0);
        this->addColor("_cyangold_40", 202, 150,   0);
        this->addColor("_cyangold_41", 207, 160,   0);
        this->addColor("_cyangold_42", 212, 170,   0);
        this->addColor("_cyangold_43", 218, 180,   0);
        this->addColor("_cyangold_44", 223, 190,   0);
        this->addColor("_cyangold_45", 228, 200,   0);
        this->addColor("_cyangold_46", 233, 210,   0);
        this->addColor("_cyangold_47", 238, 221,   0);
        this->addColor("_cyangold_48", 243, 231,   2);
        this->addColor("_cyangold_49", 248, 241,  18);
        this->addColor("_cyangold_50", 253, 255,  34);

        // Descending scalar mapping: +1.0 (gold) to -1.0 (cyan), step=0.04
        asoDiverging.addScalarAndColor(  1.0000f, "_cyangold_50");
        asoDiverging.addScalarAndColor(  0.9600f, "_cyangold_49");
        asoDiverging.addScalarAndColor(  0.9200f, "_cyangold_48");
        asoDiverging.addScalarAndColor(  0.8800f, "_cyangold_47");
        asoDiverging.addScalarAndColor(  0.8400f, "_cyangold_46");
        asoDiverging.addScalarAndColor(  0.8000f, "_cyangold_45");
        asoDiverging.addScalarAndColor(  0.7600f, "_cyangold_44");
        asoDiverging.addScalarAndColor(  0.7200f, "_cyangold_43");
        asoDiverging.addScalarAndColor(  0.6800f, "_cyangold_42");
        asoDiverging.addScalarAndColor(  0.6400f, "_cyangold_41");
        asoDiverging.addScalarAndColor(  0.6000f, "_cyangold_40");
        asoDiverging.addScalarAndColor(  0.5600f, "_cyangold_39");
        asoDiverging.addScalarAndColor(  0.5200f, "_cyangold_38");
        asoDiverging.addScalarAndColor(  0.4800f, "_cyangold_37");
        asoDiverging.addScalarAndColor(  0.4400f, "_cyangold_36");
        asoDiverging.addScalarAndColor(  0.4000f, "_cyangold_35");
        asoDiverging.addScalarAndColor(  0.3600f, "_cyangold_34");
        asoDiverging.addScalarAndColor(  0.3200f, "_cyangold_33");
        asoDiverging.addScalarAndColor(  0.2800f, "_cyangold_32");
        asoDiverging.addScalarAndColor(  0.2400f, "_cyangold_31");
        asoDiverging.addScalarAndColor(  0.2000f, "_cyangold_30");
        asoDiverging.addScalarAndColor(  0.1600f, "_cyangold_29");
        asoDiverging.addScalarAndColor(  0.1200f, "_cyangold_28");
        asoDiverging.addScalarAndColor(  0.0800f, "_cyangold_27");
        asoDiverging.addScalarAndColor(  0.0400f, "_cyangold_26");
        asoDiverging.addScalarAndColor(  0.0000f, "_cyangold_25");
        asoDiverging.addScalarAndColor( -0.0400f, "_cyangold_24");
        asoDiverging.addScalarAndColor( -0.0800f, "_cyangold_23");
        asoDiverging.addScalarAndColor( -0.1200f, "_cyangold_22");
        asoDiverging.addScalarAndColor( -0.1600f, "_cyangold_21");
        asoDiverging.addScalarAndColor( -0.2000f, "_cyangold_20");
        asoDiverging.addScalarAndColor( -0.2400f, "_cyangold_19");
        asoDiverging.addScalarAndColor( -0.2800f, "_cyangold_18");
        asoDiverging.addScalarAndColor( -0.3200f, "_cyangold_17");
        asoDiverging.addScalarAndColor( -0.3600f, "_cyangold_16");
        asoDiverging.addScalarAndColor( -0.4000f, "_cyangold_15");
        asoDiverging.addScalarAndColor( -0.4400f, "_cyangold_14");
        asoDiverging.addScalarAndColor( -0.4800f, "_cyangold_13");
        asoDiverging.addScalarAndColor( -0.5200f, "_cyangold_12");
        asoDiverging.addScalarAndColor( -0.5600f, "_cyangold_11");
        asoDiverging.addScalarAndColor( -0.6000f, "_cyangold_10");
        asoDiverging.addScalarAndColor( -0.6400f, "_cyangold_09");
        asoDiverging.addScalarAndColor( -0.6800f, "_cyangold_08");
        asoDiverging.addScalarAndColor( -0.7200f, "_cyangold_07");
        asoDiverging.addScalarAndColor( -0.7600f, "_cyangold_06");
        asoDiverging.addScalarAndColor( -0.8000f, "_cyangold_05");
        asoDiverging.addScalarAndColor( -0.8400f, "_cyangold_04");
        asoDiverging.addScalarAndColor( -0.8800f, "_cyangold_03");
        asoDiverging.addScalarAndColor( -0.9200f, "_cyangold_02");
        asoDiverging.addScalarAndColor( -0.9600f, "_cyangold_01");
        asoDiverging.addScalarAndColor( -1.0000f, "_cyangold_00");
    ...
    if (modifiedStatus == false) {
        ...
        //----------------------------------------------------------------------
        // cyangoldERGING palette
        // Cyan-Blue-Black-Gold-Yellow diverging colormap
        //
        if (this->getPaletteByName("cyangoldERGING") == NULL) {
            Palette asoDiverging;
            asoDiverging.setName("cyangoldERGING");
        
            // Color definitions (sampled from 256-entry colormap)
            this->addColor("_cyangold_00",  25, 252, 255);
            this->addColor("_cyangold_01",   5, 239, 255);
            this->addColor("_cyangold_02",   0, 223, 255);
            this->addColor("_cyangold_03",   0, 208, 255);
            this->addColor("_cyangold_04",   0, 192, 255);
            this->addColor("_cyangold_05",   0, 177, 255);
            this->addColor("_cyangold_06",   0, 162, 255);
            this->addColor("_cyangold_07",   0, 147, 255);
            this->addColor("_cyangold_08",   0, 131, 255);
            this->addColor("_cyangold_09",   0, 116, 255);
            this->addColor("_cyangold_10",   0, 101, 255);
            this->addColor("_cyangold_11",   0,  86, 255);
            this->addColor("_cyangold_12",   0,  70, 254);
            this->addColor("_cyangold_13",   0,  60, 244);
            this->addColor("_cyangold_14",   0,  55, 224);
            this->addColor("_cyangold_15",   0,  50, 203);
            this->addColor("_cyangold_16",   0,  45, 183);
            this->addColor("_cyangold_17",   0,  40, 163);
            this->addColor("_cyangold_18",   0,  34, 142);
            this->addColor("_cyangold_19",   0,  29, 122);
            this->addColor("_cyangold_20",   0,  24, 102);
            this->addColor("_cyangold_21",   0,  19,  82);
            this->addColor("_cyangold_22",   0,  14,  61);
            this->addColor("_cyangold_23",   0,   9,  40);
            this->addColor("_cyangold_24",   0,   4,  19);
            this->addColor("_cyangold_25",   1,   0,   3);
            this->addColor("_cyangold_26",  10,   6,   0);
            this->addColor("_cyangold_27",  25,  16,   0);
            this->addColor("_cyangold_28",  41,  27,   0);
            this->addColor("_cyangold_29",  56,  37,   0);
            this->addColor("_cyangold_30",  71,  47,   0);
            this->addColor("_cyangold_31",  86,  57,   0);
            this->addColor("_cyangold_32", 101,  67,   0);
            this->addColor("_cyangold_33", 117,  77,   0);
            this->addColor("_cyangold_34", 133,  88,   0);
            this->addColor("_cyangold_35", 148,  98,   0);
            this->addColor("_cyangold_36", 163, 108,   0);
            this->addColor("_cyangold_37", 178, 118,   0);
            this->addColor("_cyangold_38", 191, 129,   0);
            this->addColor("_cyangold_39", 197, 139,   0);
            this->addColor("_cyangold_40", 202, 149,   0);
            this->addColor("_cyangold_41", 207, 159,   0);
            this->addColor("_cyangold_42", 212, 169,   0);
            this->addColor("_cyangold_43", 217, 180,   0);
            this->addColor("_cyangold_44", 222, 190,   0);
            this->addColor("_cyangold_45", 227, 200,   0);
            this->addColor("_cyangold_46", 232, 210,   0);
            this->addColor("_cyangold_47", 237, 220,   0);
            this->addColor("_cyangold_48", 242, 230,   2);
            this->addColor("_cyangold_49", 248, 241,  18);
            this->addColor("_cyangold_50", 253, 251,  33);
        
            // Scalar to color mapping
            asoDiverging.addScalarAndColor(-1.0000f, "_cyangold_00");
            asoDiverging.addScalarAndColor(-0.9688f, "_cyangold_01");
            asoDiverging.addScalarAndColor(-0.9375f, "_cyangold_02");
            asoDiverging.addScalarAndColor(-0.9062f, "_cyangold_03");
            asoDiverging.addScalarAndColor(-0.8750f, "_cyangold_04");
            asoDiverging.addScalarAndColor(-0.8438f, "_cyangold_05");
            asoDiverging.addScalarAndColor(-0.8125f, "_cyangold_06");
            asoDiverging.addScalarAndColor(-0.7812f, "_cyangold_07");
            asoDiverging.addScalarAndColor(-0.7500f, "_cyangold_08");
            asoDiverging.addScalarAndColor(-0.7188f, "_cyangold_09");
            asoDiverging.addScalarAndColor(-0.6875f, "_cyangold_10");
            asoDiverging.addScalarAndColor(-0.6562f, "_cyangold_11");
            asoDiverging.addScalarAndColor(-0.6250f, "_cyangold_12");
            asoDiverging.addScalarAndColor(-0.5938f, "_cyangold_13");
            asoDiverging.addScalarAndColor(-0.5625f, "_cyangold_14");
            asoDiverging.addScalarAndColor(-0.5312f, "_cyangold_15");
            asoDiverging.addScalarAndColor(-0.5000f, "_cyangold_16");
            asoDiverging.addScalarAndColor(-0.4688f, "_cyangold_17");
            asoDiverging.addScalarAndColor(-0.4375f, "_cyangold_18");
            asoDiverging.addScalarAndColor(-0.4062f, "_cyangold_19");
            asoDiverging.addScalarAndColor(-0.3750f, "_cyangold_20");
            asoDiverging.addScalarAndColor(-0.3438f, "_cyangold_21");
            asoDiverging.addScalarAndColor(-0.3125f, "_cyangold_22");
            asoDiverging.addScalarAndColor(-0.2812f, "_cyangold_23");
            asoDiverging.addScalarAndColor(-0.2500f, "_cyangold_24");
            asoDiverging.addScalarAndColor(-0.2188f, "_cyangold_25");
            asoDiverging.addScalarAndColor(-0.1875f, "_cyangold_26");
            asoDiverging.addScalarAndColor(-0.1562f, "_cyangold_27");
            asoDiverging.addScalarAndColor(-0.1250f, "_cyangold_28");
            asoDiverging.addScalarAndColor(-0.0938f, "_cyangold_29");
            asoDiverging.addScalarAndColor(-0.0625f, "_cyangold_30");
            asoDiverging.addScalarAndColor(-0.0312f, "_cyangold_31");
            asoDiverging.addScalarAndColor( 0.0000f, "_cyangold_32");
            asoDiverging.addScalarAndColor( 0.0312f, "_cyangold_33");
            asoDiverging.addScalarAndColor( 0.0625f, "_cyangold_34");
            asoDiverging.addScalarAndColor( 0.0938f, "_cyangold_35");
            asoDiverging.addScalarAndColor( 0.1250f, "_cyangold_36");
            asoDiverging.addScalarAndColor( 0.1562f, "_cyangold_37");
            asoDiverging.addScalarAndColor( 0.1875f, "_cyangold_38");
            asoDiverging.addScalarAndColor( 0.2188f, "_cyangold_39");
            asoDiverging.addScalarAndColor( 0.2500f, "_cyangold_40");
            asoDiverging.addScalarAndColor( 0.2812f, "_cyangold_41");
            asoDiverging.addScalarAndColor( 0.3125f, "_cyangold_42");
            asoDiverging.addScalarAndColor( 0.3438f, "_cyangold_43");
            asoDiverging.addScalarAndColor( 0.3750f, "_cyangold_44");
            asoDiverging.addScalarAndColor( 0.4062f, "_cyangold_45");
            asoDiverging.addScalarAndColor( 0.4375f, "_cyangold_46");
            asoDiverging.addScalarAndColor( 0.4688f, "_cyangold_47");
            asoDiverging.addScalarAndColor( 0.5000f, "_cyangold_48");
            asoDiverging.addScalarAndColor( 0.5312f, "_cyangold_49");
            asoDiverging.addScalarAndColor( 0.5625f, "_cyangold_50");
